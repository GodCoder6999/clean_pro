...
class App {
  ...
  async route() {
    ...
    if (queryIdx !== -1) {
      const qs = new URLSearchParams(path.substring(queryIdx));
      if (qs.has('token')) {
      ...
      <div class="auth-card">
        ...
        <div style="margin-top: 1.5rem; text-align: center;">
          <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
            <hr style="flex: 1; border: none; border-top: 1px solid var(--border);"><span style="padding: 0 10px; color: var(--text-muted); font-size: 0.85rem;">OR</span><hr style="flex: 1; border: none; border-top: 1px solid var(--border);">
          </div>
          <button class="btn btn-ghost btn-lg btn-block" style="display: flex; align-items: center; justify-content: center; gap: 8px; border: 1px solid var(--border);" onclick="window.location.href='/api/auth/google'">
